Shader "Bakery/Standard_Blood"
{
    Properties
    {
        ...
        [NoScaleOffset]_MainTexBlood("Albedo Blood", 2D) = "white" {}
        ...
        [NoScaleOffset]_MetallicGlossMapBlood("Metallic Blood", 2D) = "white" {}
        ...
        [NoScaleOffset]_BumpMapBlood("Normal Map Blood", 2D) = "bump" {}

        [Space(20)]
        [NoScaleOffset]_MutilationMaskA ("Mutilation Mask A LeftHand(R) RightHand(G) LeftFoot(B) RightFoot(A)", 2D) = "white" {}
        _MaskA_R("LeftHand(R)", Range(0.0, 1.0)) = 0.0
        _MaskA_G("RightHand(G)", Range(0.0, 1.0)) = 0.0
        _MaskA_B("LeftFoot(B)", Range(0.0, 1.0)) = 0.0
        _MaskA_A("RightFoot(A)", Range(0.0, 1.0)) = 0.0

        [Space(20)]
        [NoScaleOffset]_MutilationMaskB ("Mutilation Mask B Head(R) Body(G)", 2D) = "white" {}
        _MaskB_R("Head(R)", Range(0.0, 1.0)) = 0.0
        _MaskB_G("Body(G)", Range(0.0, 1.0)) = 0.0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/Bakery/shader/UnityStandardCoreForward_Blood.cginc"
            //#include "Bakery.cginc"
            #include "Assets/Bakery/shader/Bakery_Blood.cginc"
        ...
        Pass
        {
            ...
            #include "Assets/Bakery/shader/UnityStandardCore_Blood.cginc"
            #include "Assets/Bakery/shader/Bakery_Blood.cginc"
    ...
    FallBack "VertexLit"
    CustomEditor "BakeryShaderGUI_Blood"
}
